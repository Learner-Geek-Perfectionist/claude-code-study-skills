...
echo "  * Reports:  /tmp/study-master-profiling-report-*.md"
echo ""
echo "To clean up logs manually:"
echo "  rm -f /tmp/study-master-tool.log /tmp/study-master-profiling-report-*.md"
