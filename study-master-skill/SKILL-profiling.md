...
> ⏱️ **[诊断]** 开始生成 overview，运行：
> ```
> Bash: echo "PHASE|generate-overview|start|$(date +%s)" >> study/<topic>/.profiling.log
> ```
...
> ⏱️ **[诊断]** overview 生成完成，运行：
> ```
> Bash: echo "PHASE|generate-overview|end|$(date +%s)" >> study/<topic>/.profiling.log
> ```
